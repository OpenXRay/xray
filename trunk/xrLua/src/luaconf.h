...
*/
	...
	__forceinline int _lua_number2int_	(double d)	{
		int		r;
		__asm	{
			fld d;
			fistp r;
	...
	#define lua_number2int(i,d)	((i)=(int)_lua_number2int_(d))
	#define lua_number2integer(i,d)	((i)=(lua_Integer)_lua_number2int_(d))
#else
